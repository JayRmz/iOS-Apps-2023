...
struct StoryBrain {
    ...
    mutating func nextStory (userChoice: String) {
        if userChoice == storyArray[currentHistory].choice1 {
            currentHistory = storyArray[currentHistory].choice1Destination
        } else {
            currentHistory = storyArray[currentHistory].choice2Destination
        }
    }
    
    func getStoryText() -> String {
        return storyArray[currentHistory].title
    }
    
    func getChoice1() -> String {
        return storyArray[currentHistory].choice1
    }
    
    func getChoice2() -> String {
        return storyArray[currentHistory].choice2
    }
}
